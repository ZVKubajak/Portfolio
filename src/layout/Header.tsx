...
const Header = () => {
  return (
    <header className="relative z-50">
      <motion.div
        className="fixed top-0 w-full bg-white opacity-70 border-b-2 border-b-gray-300 shadow-lg shadow-black/10 lg:bg-inherit lg:opacity-100 lg:border-none lg:shadow-none"
